...
class FTPClient {
	...
	public static void main(String argv[]) throws Exception {
		...
		int port, port1;
		String splashScreen1 = "\n-----Simple FTP-----\n \n--Actions-----------\nconnect (<connect> <server name> <port>)\n";
		System.out.print(splashScreen1);
		...
		if (sentence.startsWith("connect")) {
			...
			System.out.print(splashScreen1 + splashScreen2);
			...
			System.out.println(splashScreen2 + splashScreen3);
